namespace XNALara
{
    public class GoLBruteMinion : Item
    {
        public GoLBruteMinion(Game game)
            : base(game) {
        }

        protected override void DefineMeshGroups() {
            model.DefineMeshGroup(MeshGroupNames.MeshGroup4, "mesh001", "mesh002", "mesh003left", "mesh003right", "mesh004");
        }
