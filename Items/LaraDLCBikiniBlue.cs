namespace XNALara
{
    public class LaraDLCBikiniBlue : Lara
    {
        public LaraDLCBikiniBlue(Game game)
            : base(game) {
        }

        protected override void DefineMeshGroups() {
            base.DefineMeshGroups();
            model.DefineMeshGroup(MeshGroupNames.MeshGroup1, "mesh013", "mesh015", "mesh022", "mesh023", "mesh027");
            model.DefineMeshGroup(MeshGroupNames.MeshGroup2, "mesh001", "mesh008", "mesh010", "mesh017", "mesh018", "mesh019", "mesh020", "mesh021", "mesh024", "mesh025");
        ...
        protected override void SetRenderParams() {
            ...
            model.GetMesh("mesh027").RenderParams = new object[] { 0.1f, 12.0f, 16.0f };
        }
    }
}
