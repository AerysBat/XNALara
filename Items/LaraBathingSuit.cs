namespace XNALara
{
    public class LaraBathingSuit : Lara
    {
        public LaraBathingSuit(Game game)
            : base(game) {
        }

        protected override void DefineMeshGroups() {
            base.DefineMeshGroups();
            model.DefineMeshGroup(MeshGroupNames.MeshGroup1, "backpack", "belts", "collar", "gear2", "gear3", "gear6", "suit");
