namespace XNALara
{
    public class LaraDLCBikiniCamo : Lara
    {
        public LaraDLCBikiniCamo(Game game)
            : base(game) {
        }

        protected override void DefineMeshGroups() {
            base.DefineMeshGroups();
            model.DefineMeshGroup(MeshGroupNames.MeshGroup1, "mesh013", "mesh015", "mesh022", "mesh023", "mesh025");
