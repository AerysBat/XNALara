namespace XNALara
{
    public class LaraJunglePants : Lara
    {
        public LaraJunglePants(Game game)
            : base(game) {
        }

        protected override void DefineMeshGroups() {
            base.DefineMeshGroups();
            model.DefineMeshGroup(MeshGroupNames.MeshGroup1, "backpack", "belts", "boots", "gloves", "trousers", "tshirt");
            model.DefineMeshGroup(MeshGroupNames.MeshGroup2, "body", "eyeducts", "face", "fingers", "light1", "mouth", "ribbon");
        ...
        protected override void SetRenderParams() {
            ...
            model.GetMesh("trousers").RenderParams = new object[] { 0.1f, 24.0f, 24.0f };
