namespace XNALara
{
    public class Natla : Item
    {
        public Natla(Game game)
            : base(game) {
        }

        protected override void DefineMeshGroups() {
            model.DefineMeshGroup(MeshGroupNames.MeshGroup1, "arms", "detail3", "jacket", "trousers", "wingbonesleft", "wingbonesright", "wingleft", "wingright");
